        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: instents.bottom + 30 }}>
          ...
          <View style={{ paddingHorizontal: moderateScale(20) }}>
            ...
            <View>
              ...
              <TextInput placeholder='Enter your Email' keyboardType='email-address' style={styles.inputField} />
            </View>
            <View>
              <Text style={styles.labelName}>Email</Text>
              <TextInput placeholder='Enter your Password' secureTextEntry style={styles.inputField} />
            </View>
            ...
            <View>
              <Link href={'/sign'} style={{ textAlign: 'center', fontSize: moderateScale(20), fontWeight: 600 }}>Sign</Link>
            </View>
          </View>
